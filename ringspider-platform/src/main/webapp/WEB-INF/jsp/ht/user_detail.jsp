                                ...
                                <div class="panel">
                                    ...
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
                                            <a data-parent="#demo-accordion" data-toggle="collapse" href="#demo-acc-panel-1">用户详情</a>
                                        </h4>
                                    </div>
                                    ...
                                    <div  >
                                        <div class="panel-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-7">
                                                    <input type="text" class="form-control" name="phone" placeholder="请输入手机号码" value="${user.phone}">
                                                </div>
                                            </div>
                                            <div class="form-group">
